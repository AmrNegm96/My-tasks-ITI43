...
namespace MVC_Areas.Controllers
{
    public class ProductsController : Controller
    {
        ...
        {
            ViewBag.CategoyID = new SelectList(db.Categories, "CategoryID", "CategoryName");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "ProductID,ProductName,SupplierID,CategoryID,QuantityPerUnit,UnitPrice,UnitsInStock,UnitsOnOrder,ReorderLevel,Discontinued")] Product product)
        {
            ...
            ViewBag.CategoyID = new SelectList(db.Categories, "CategoryID", "CategoryName", product.CategoryID);
            return View(product);
        }
